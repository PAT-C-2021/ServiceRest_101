...
namespace ServiceRest_101_Raditya_Pratama_Putra
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=RADITYA-PRATAMA;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=pratamaputra1");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=RADITYA-PRATAMA;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=pratamaputra1");
